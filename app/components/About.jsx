...
const About = () => {
    return (
        <div id='about' className='w-full px-[12%] py-10 scroll-mt-16 mb-20'>
            <h4 className='text-center mb-2 text-lg Ovo'>Introduction</h4>
            <h2 className='text-center text-5xl Ovo'>About Me</h2>

            <div className='flex flex-col md:flex-row gap-10 mt-10 w-full items-center'>

                <div className="md:w-1/3 w-full flex justify-center self-center">
                    <div className="w-64 sm:w-72 h-80 sm:h-96 rounded-2xl overflow-hidden shadow-xl border border-gray-200">
                        <Image
            ...
            hover:shadow-md hover:-translate-y-1 transition-all bg-white'
                    ...
                    <h4 className='mt-4 font-semibold text-lg'>Tools I use</h4>
